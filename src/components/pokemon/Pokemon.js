            ...
            <div className="row">
              <div className="col-md-6">
                <div className="row">
                  ...
                  <div className="col-6">
                    <h6 className="float-left">{this.state.height} mts.</h6>
                  </div>
                  <div className="col-6">
                  ...
                  <div className="col-6">
                    <h6 className="float-right">Porcentaje de Captura :</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-left">{this.state.catchRate}%</h6>
                  </div>
                  <div className="col-6">
                    <h6 className="float-right">Proporcion Genero:</h6>
                  </div>
                  <div className="col-6">
                    <div class="progress">
                      <div
              ...
              <div className="col-md-6">
                <div className="row">
                  <div className="col-6">
                    <h6 className="float-right">Grupo de huevos:</h6>
                  </div>
                  <div className="col-6">
